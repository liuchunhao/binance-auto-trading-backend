...
EVENT_TYPE = {
    'depthUpdate': on_resp_depth,
    'aggTrade': on_resp_agg_trade,
    'markPriceUpdate': on_resp_mark_price,
} 
...
if __name__ == "__main__":
    ...
    ws = websocket.WebSocketApp("wss://fstream.binance.com/ws/{}".format(listen_key),
